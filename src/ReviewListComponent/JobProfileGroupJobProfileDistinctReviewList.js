...
import { getJobProfileGroupJobProfileDistinctApiCall } from '../Actions/ActionJobProfile';

const JobProfileGroupJobProfileDistinctReviewList = (props) => {
...
*/
  ...
  return (
    <div>
      {listDistinctData && (
        <Card
          textOneOne={listDistinctData.jobProfileGroupName}
          textTwoOne={listDistinctData.jobProfileGroupDescription}
          IconOne={CrossIcon}
          isIcon={true}
          labelTwoTwo={'group'}
      ...
      {FilterMode === 'jobGroupJobDistinctinactive' && (
        <FooterIconTwo
          FilterModeEnable={isShowReviseIcon}
          FilterMode={FilterMode}
          onClick={onClickRevise}
...
export default JobProfileGroupJobProfileDistinctReviewList;
