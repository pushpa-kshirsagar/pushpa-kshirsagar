...
const CultureProfileAssessmentDistinctReviewList = (props) => {
...
*/
  ...
  return (
    <div>
      {listDistinctData && (
        <Card
          textOneOne={listDistinctData.cultureProfileName}
          textTwoOne={listDistinctData.cultureProfileDescription}
          IconOne={CrossIcon}
          isIcon={true}
          labelTwoTwo={'type'}
...
export default CultureProfileAssessmentDistinctReviewList;
