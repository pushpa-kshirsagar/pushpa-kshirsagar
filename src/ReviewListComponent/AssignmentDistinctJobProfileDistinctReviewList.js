...
const AssignmentDistinctJobProfileDistinctReviewList = (props) => {
  ...
  const onClickReviseFinish = () => {
    ...
    dispatch({
      ...
      payload: { listName: 'assignmentJobProfileList', value: selectedTagsArray }
    });
  };
...
*/
  ...
  return (
    <div>
      ...
      {FilterMode === 'assignmentDistinctJobProfileRevise' && (
        <FooterIconTwo
      ...
      {FilterMode === 'jobDistinctJobDistinctinactive' && (
        <FooterIconTwo
          FilterModeEnable={isShowReviseIcon}
          FilterMode={FilterMode}
          onClick={onClickRevise}
...
export default AssignmentDistinctJobProfileDistinctReviewList;
