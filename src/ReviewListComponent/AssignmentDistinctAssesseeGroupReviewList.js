...
const AssignmentDistinctAssesseeGroupReviewList = (props) => {
  ...
  */
  ...
  const onClickReviseFinish = () => {
    ...
    dispatch({
      ...
      payload: { listName: 'assignmentAssesseeGroupList', value: selectedTagsArray }
    });
  };
  ...
  return (
    <div>
      ...
      {listDistinctData &&
        listDistinctData.assesseeGroup.map((item, index) => {
          return (
      ...
      {FilterMode === 'assignmentDistinctAssesseeGroupRevise' && (
        <FooterIconTwo
...
export default AssignmentDistinctAssesseeGroupReviewList;
