        ...
        <div className="containerPadding sticky-header">
          <div style={{ height: '49px', padding: '0 5px', display: 'flex' }} className={''}>
            ...
            <div
              ...
              className="flex-center"
            >
              <IconButton onClick={(e)=>{props.onClickFlag(props.id)}} className={'assessmentFlagButton'}>
  ...
  return (
    <>
      ...
      <div className="containerPadding">
        <AssessmentHeader
          score={isAssessmentSectionShow ?
            informationFramework?.assessmentSectionItemDistinct[currentItemIndex]?.itemFrameworkOneScore :
            informationFramework?.assessmentSection[currentSectionIndex]?.assessmentSectionItemDistinct[currentItemIndex]?.itemFrameworkOneScore}
          // assessmentName={informationBasic?.assessmentName || ''}
          // assessmentDesc={informationBasic?.assessmentDescription || ''}
          assessmentName={isAssessmentSectionShow ? informationBasic?.assessmentName :
            isAssessmentPreviewShow ? informationBasic?.assessmentName :
              informationFramework?.assessmentName}
          assessmentDesc={isAssessmentSectionShow ? informationBasic?.assessmentDescription : isAssessmentPreviewShow ? informationBasic?.assessmentDescription :
            informationFramework?.assessmentDescription || ''}
          id={informationFramework?.assessmentSection[currentSectionIndex]?.assessmentSectionItemDistinct[currentItemIndex]?.itemId}
          //isQuestionFlaged={isQuestionFlaged}
          onClickFlag={flagQuestion}
          isQuestionFlaged={informationFramework?.assessmentSection[currentSectionIndex]?.assessmentSectionItemDistinct[currentItemIndex]?.isFlagged}
                    ...
                    <div className="option-container ex_container" key={`option-${key}`}>
                      ...
                      >
                        <input
                          ...
                          onChange={isAssessmentPreviewShow || isAssessmentSectionShow ? null : handleRadioButton}
                          checked={isAssessmentPreviewShow || isAssessmentSectionShow ?
