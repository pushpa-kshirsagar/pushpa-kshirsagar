...
function* workerAllocateAssignmentSaga(data) {
  try {
    const Response = yield call(callInfoApi, {
      data: data.payload.request,
      URL: ASSIGNMENT_ALLOCATE_URL
    });
...
export default function* watchAssignmentAllocateSaga() {
  yield takeLatest(ASSIGNMENT_ALLOCATE_SAGA, workerAllocateAssignmentSaga);
}
