...
const AssignmentDistinctJobProfileGroupReviewList = (props) => {
  ...
  */
  ...
  const onClickReviseFinish = () => {
    ...
    dispatch({
      ...
      payload: { listName: 'assignmentJobProfileGroupList', value: selectedTagsArray }
    });
  };
  ...
  return (
    <div>
      ...
      {listDistinctData &&
        listDistinctData.jobProfileGroup.map((item, index) => {
          return (
      ...
      {FilterMode === 'assignmentDistinctJobProfileGroupRevise' && (
        <FooterIconTwo
...
export default AssignmentDistinctJobProfileGroupReviewList;
