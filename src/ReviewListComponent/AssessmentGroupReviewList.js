...
const AssessmentGroupReviewList = (props) => {
  ...
  return (
    <div>
          ...
          return (
            <div className="containerPadding" key={index}>
              <ReviewList
                ...
                status={FilterMode === 'assessmentGroupDistinctactive'?
                item.informationSetup?.assessmentGroupClassification?.assessmentGroupClassificationPrimary:
                item.informationEngagement.assessmentGroupStatus}
      ...
      {FilterMode === 'assessmentGroupDistinctactive' && (
        <FooterIconTwo
          FilterModeEnable={FilterModeEnable}
          FilterMode={FilterMode}
          onClick={onClickFooter}
