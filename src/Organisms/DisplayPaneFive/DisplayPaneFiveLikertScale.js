...
const DisplayPaneFiveLikertScale = (props) => {
  ...
  const { subItemList=[], setSubItemList } = props;
  ...
  return (
    <>
      ...
      <div>
        ...
        >
          {ReactHTMLParser(
            itemFrameworkOne?.itemFrameworkOneResponseExplanation?.itemFrameworkOneResponseExplanation || responseDescription
          )}
        </div>
      </div>
      <div>
...
export default DisplayPaneFiveLikertScale;
