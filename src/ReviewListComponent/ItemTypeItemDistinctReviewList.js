...
const ItemTypeItemDistinctReviewList = (props) => {
...
*/
  ...
  return (
    <div>
      {listDistinctData && (
        <Card
          textOneOne={listDistinctData.itemTypeName}
          textTwoOne={listDistinctData.itemTypeDescription}
          IconOne={CrossIcon}
          isIcon={true}
          labelTwoTwo={'type'}
      ...
      {FilterMode === 'itemTypeItemDistinctinactive' && (
        <FooterIconTwo
          FilterModeEnable={isShowReviseIcon}
          FilterMode={FilterMode}
          onClick={onClickRevise}
...
export default ItemTypeItemDistinctReviewList;
