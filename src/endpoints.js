...
export const CULTURE_TYPE_SHARE_URL = ANALYTICS + '';
export const CULTURE_TYPE_UNSHARE_URL = ANALYTICS + '';
//job
...
export const JOB_TYPE_SHARE_URL = ANALYTICS + '';
export const JOB_TYPE_UNSHARE_URL = ANALYTICS + '';
